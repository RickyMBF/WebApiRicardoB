...
using WebApiRicardoB.Controllers;
using WebApiRicardoB.Filtros;
using WebApiRicardoB.Middlewares;
...
namespace WebApiRicardoB
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddHostedService<Punto3>();
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           // services.AddHostedService<EscribirEnArchivo>();
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "WebAPIRicardoB", Version = "v1" });
            });
